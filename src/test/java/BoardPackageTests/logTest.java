...
public class logTest{
	...
	@Before
	public void setUp(){
		pathReader = BoardReader.getPath();
		pathWriter = BoardWriter.getPath();
		BoardReader.setPath("./src/test/resources/test.json");
		BoardWriter.setPath("./src/test/resources/test.json");

		// clear out file generated by previous tests
	...
	public void tearDown(){
		...
		BoardReader.setPath(pathReader);
		BoardWriter.setPath(pathWriter);
	}
	@Test
